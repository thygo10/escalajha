...
export const INITIAL_FUNCIONARIOS: Funcionario[] = [
  // 1. Frente de Caixa
  { id: 'f_fc1', loja_id: 'loja-02-demo', primeiro_nome: 'Nayle', matricula_aleatoria: '748291', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '08:00 às 16:00', genero: 'F', ativo: true },
  { id: 'f_fc2', loja_id: 'loja-02-demo', primeiro_nome: 'Alane', matricula_aleatoria: '482019', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '08:00 às 16:00', genero: 'F', ativo: true },
  { id: 'f_fc3', loja_id: 'loja-02-demo', primeiro_nome: 'Ana Paula', matricula_aleatoria: '920148', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '08:00 às 16:00', genero: 'F', ativo: true },
  { id: 'f_fc4', loja_id: 'loja-02-demo', primeiro_nome: 'John', matricula_aleatoria: '830194', setor: 'Frente de Caixa', cargo: 'Operador de Caixa', turno_padrao: '08:00 às 16:00', genero: 'M', ativo: true },
  { id: 'f_fc5', loja_id: 'loja-02-demo', primeiro_nome: 'Ana Luísa', matricula_aleatoria: '502918', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '08:00 às 16:00', genero: 'F', ativo: true },
  { id: 'f_fc6', loja_id: 'loja-02-demo', primeiro_nome: 'Jaqueline', matricula_aleatoria: '392018', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '08:00 às 16:00', genero: 'F', ativo: true },
  { id: 'f_fc7', loja_id: 'loja-02-demo', primeiro_nome: 'Ana Beatriz', matricula_aleatoria: '719204', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '08:00 às 16:00', genero: 'F', ativo: true },
  { id: 'f_fc8', loja_id: 'loja-02-demo', primeiro_nome: 'Jaine', matricula_aleatoria: '640192', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '10:00 às 18:00', genero: 'F', ativo: true },
  { id: 'f_fc9', loja_id: 'loja-02-demo', primeiro_nome: 'Kamilly', matricula_aleatoria: '649201', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '10:00 às 18:00', genero: 'F', ativo: true },
  { id: 'f_fc10', loja_id: 'loja-02-demo', primeiro_nome: 'Ana Félix', matricula_aleatoria: '319482', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '10:00 às 18:00', genero: 'F', ativo: true },
  { id: 'f_fc11', loja_id: 'loja-02-demo', primeiro_nome: 'Sabrina', matricula_aleatoria: '619284', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '10:00 às 18:00', genero: 'F', ativo: true },
  { id: 'f_fc12', loja_id: 'loja-02-demo', primeiro_nome: 'Viviane', matricula_aleatoria: '840192', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '10:00 às 18:00', genero: 'F', ativo: true },
  { id: 'f_fc13', loja_id: 'loja-02-demo', primeiro_nome: 'Laísa', matricula_aleatoria: '183920', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '12:00 às 20:00', genero: 'F', ativo: true },
  { id: 'f_fc14', loja_id: 'loja-02-demo', primeiro_nome: 'Ana Cláudia', matricula_aleatoria: '572910', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '12:00 às 20:00', genero: 'F', ativo: true },
  { id: 'f_fc15', loja_id: 'loja-02-demo', primeiro_nome: 'Claudia', matricula_aleatoria: '294018', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '12:00 às 20:00', genero: 'F', ativo: true },
  { id: 'f_fc16', loja_id: 'loja-02-demo', primeiro_nome: 'Joesiane', matricula_aleatoria: '940182', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '12:00 às 20:00', genero: 'F', ativo: true },
  { id: 'f_fc17', loja_id: 'loja-02-demo', primeiro_nome: 'Sueli', matricula_aleatoria: '381029', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '12:00 às 20:00', genero: 'F', ativo: true },
  { id: 'f_fc18', loja_id: 'loja-02-demo', primeiro_nome: 'Luciene', matricula_aleatoria: '729104', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '12:00 às 20:00', genero: 'F', ativo: true },
  { id: 'f_fc19', loja_id: 'loja-02-demo', primeiro_nome: 'Luciana', matricula_aleatoria: '610294', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '12:00 às 20:00', genero: 'F', ativo: true },
  { id: 'f_fc20', loja_id: 'loja-02-demo', primeiro_nome: 'Mateus', matricula_aleatoria: '492018', setor: 'Frente de Caixa', cargo: 'Operador de Caixa', turno_padrao: '12:00 às 20:00', genero: 'M', ativo: true },
  { id: 'f_fc21', loja_id: 'loja-02-demo', primeiro_nome: 'Natália', matricula_aleatoria: '819204', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '12:00 às 20:00', genero: 'F', ativo: true },
  { id: 'f_fc22', loja_id: 'loja-02-demo', primeiro_nome: 'Edma', matricula_aleatoria: '302948', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '14:00 às 22:00', genero: 'F', ativo: true },
  { id: 'f_fc23', loja_id: 'loja-02-demo', primeiro_nome: 'Analandia', matricula_aleatoria: '694018', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '14:00 às 22:00', genero: 'F', ativo: true },
  { id: 'f_fc24', loja_id: 'loja-02-demo', primeiro_nome: 'Roseli', matricula_aleatoria: '192048', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '14:00 às 22:00', genero: 'F', ativo: true },
  { id: 'f_fc25', loja_id: 'loja-02-demo', primeiro_nome: 'Edinalia', matricula_aleatoria: '583920', setor: 'Frente de Caixa', cargo: 'Operadora de Caixa', turno_padrao: '14:00 às 22:00', genero: 'F', ativo: true },
  ...
  { id: 'f_lan3', loja_id: 'loja-02-demo', primeiro_nome: 'Nicole', matricula_aleatoria: '302949', setor: 'Assistente de Lanchonete', cargo: 'Atendente de Lanchonete', turno_padrao: '08:00 às 17:00', genero: 'F', ativo: true },
  ...
  { id: 'f_lan6', loja_id: 'loja-02-demo', primeiro_nome: 'Angela', matricula_aleatoria: '583921', setor: 'Assistente de Lanchonete', cargo: 'Atendente de Lanchonete', turno_padrao: '10:00 às 18:00', genero: 'F', ativo: true },
  ...
  // 6. Fiscal de Caixa
  { id: 'f_fisc1', loja_id: 'loja-02-demo', primeiro_nome: 'Walta', matricula_aleatoria: '192050', setor: 'Fiscal de Caixa', cargo: 'Fiscal de Caixa Líder', turno_padrao: '08:00 às 17:00', genero: 'F', ativo: true },
  { id: 'f_fisc2', loja_id: 'loja-02-demo', primeiro_nome: 'Ualas', matricula_aleatoria: '583922', setor: 'Fiscal de Caixa', cargo: 'Fiscal de Caixa', turno_padrao: '10:00 às 20:00', genero: 'M', ativo: true },
  { id: 'f_fisc3', loja_id: 'loja-02-demo', primeiro_nome: 'Lane', matricula_aleatoria: '402921', setor: 'Fiscal de Caixa', cargo: 'Fiscal de Caixa', turno_padrao: '08:00 às 17:00', genero: 'F', ativo: true },
  { id: 'f_fisc4', loja_id: 'loja-02-demo', primeiro_nome: 'Romildo', matricula_aleatoria: '918207', setor: 'Fiscal de Caixa', cargo: 'Fiscal de Caixa', turno_padrao: '10:00 às 20:00', genero: 'M', ativo: true },
  ...
  // 9. Manutenção
  { id: 'f_man1', loja_id: 'loja-02-demo', primeiro_nome: 'Thiago', matricula_aleatoria: '100001', setor: 'Manutenção', cargo: 'Supervisor de TI & Manutenção', turno_padrao: '07:30 às 17:18', genero: 'M', ativo: true },
